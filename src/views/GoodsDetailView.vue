<!-- 鍟嗗搧璇︽儏 API: GET /api/user/goods/{id}; 鏍稿績瀛楁: id, sellerId, sellerName, sellerAvatar, sellerCampus, sellerScoreAvg, sellerReviewCount, categoryId, categoryName, title, detail, price, oldPrice, quality, location, status, statusDesc, cover, viewCount, favoriteCount, publishTime, images[{ url, sort, isCover }] -->
<script setup>
